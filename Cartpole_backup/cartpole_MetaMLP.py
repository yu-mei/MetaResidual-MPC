...
# ------------------------------------------------------------------------------
# Residual MLP: meta
residual_checkpoint = torch.load("MetaLearning/maml_cartpole_meta_init_2_64.pth")
residual_mlp = MLP(
...
nominal_func = cs.Function('nom', [casadi_model.x, casadi_model.u], [casadi_model.f_expl])
